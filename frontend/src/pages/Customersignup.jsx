...
setLoading(true);
        const res = await fetch('backend/customer/customersignup',
        {
            method:'POST',
            headers: {
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
     ...
     <input type='text' placeholder='Username' className='border bg-slate-300 p-3 v rounded-lg' id='name' onChange={handleChange}/>
     ...
     <input type='text' placeholder='Mobile' className='border bg-slate-300 p-3 rounded-lg' id='phone_number' onChange={handleChange}/>
     <input type='text' placeholder='Address' className='border bg-slate-300 p-3 rounded-lg' id='address' onChange={handleChange}/>
