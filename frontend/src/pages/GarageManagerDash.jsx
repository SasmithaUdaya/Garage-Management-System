...
export default function GarageManagerDash() {
    ...
    useEffect(() => {
        ...
        axios.get("http://localhost:3000/garagemanagerdash/garagemanagerdash")
            .then(response => {
    ...
    const handleRemoveAppointment = (id) => {
        ...
        if (isConfirmed) {
          // Update the absent value to true
          axios.put(`http://localhost:3000/garagemanagerdash/absent/${id}`, { absent: true })
            .then(() => {
        ...
        const handleCompleteAppointment = (id) => {
            ...
            if (isConfirmed) {
                axios.put(`http://localhost:3000/garagemanagerdash/complete/${id}`)
                    .then(response => {
